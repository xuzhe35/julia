...
@ngenerate N BitArray{length(I)+1} function getindex(B::BitArray, I0::Range1{Int}, I::NTuple{N,Union(Int,Range1{Int})}...)
    checkbounds(B, I0, I...)
...
@ngenerate N BitArray{length(I)} function getindex(B::BitArray, I::NTuple{N,Union(Int,AbstractVector{Int})}...)
    checkbounds(B, I...)
...
for T in [Real, Union(Real, AbstractArray)]
    @eval begin
        ...
        @ngenerate N function setindex!(B::BitArray, X::AbstractArray, I::NTuple{N,$T}...)
            @nexprs N d->(J_d = to_index(I_d))
            (@nref N B J) = X
            return B
        end
